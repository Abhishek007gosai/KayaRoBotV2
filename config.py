...
BOT_TOKEN = ("8691693420:AAGwvJY1A_gLRNueXE17I1A88-R2kSIQ3mg")

SET_INTERVAL = int(os.environ.get("SET_INTERVAL", 60))                              
TARGET_CHAT_ID = -1002512442401
MAIN_CHANNEL = -1003932217304
LOG_CHANNEL = -1003746574484
MONGO_URL = ("mongodb+srv://kayaxrobot:yzSgHQLteJCTXUqK@cluster0.ltk8k8h.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
MONGO_NAME = ("cluster0")
OWNER_ID = 8667251104
ADMIN_URL = os.environ.get("ADMIN_URL", "EternalsHelplineBot")
BOT_USERNAME = ("MusashiXRobot")
